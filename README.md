...
> 팀 전체 시스템(AI 서버 · 백엔드)은 [`skt-flyai-9th-full-archive`](../skt-flyai-9th-full-archive) 참고.
...
git clone https://github.com/memorycharm/skt-flyai-9th-client
cd skt-flyai-9th-client
npm install
